...
const AnimatedButton = ({ onRecordingToggle, onSubmit }) => {
  ...
  const animatedStyle = useAnimatedStyle(() => {
    return {
      ...
      opacity: 1, // Ensure opacity remains constant
    };
  });
  ...
  return (
    <TouchableOpacity onPress={toggleRecording} activeOpacity={1} style={styles.container}>
      ...
      <Svg height="300" width="300" viewBox="0 0 100 100" style={styles.staticCircle}>
        <Defs>
          <RadialGradient id="gradStatic" cx="50%" cy="50%" r="50%" fx="50%" fy="50%">
            <Stop offset="35%" stopColor="black" stopOpacity="1" />
            <Stop offset="85%" stopColor="#1754CE" stopOpacity="1" />
            <Stop offset="90%" stopColor="#1754CE" stopOpacity="0.7" />
            <Stop offset="95%" stopColor="#1754CE" stopOpacity="0.3" />
